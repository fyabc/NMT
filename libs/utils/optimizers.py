...
from ..utils.basic import floatX

__author__ = 'fyabc'


class Optimizer(NameRegister):
    NameTable = {}
...
class AdaDelta(Optimizer):
    ...
    def apply(cls, learning_rate, parameters, grads, inputs, cost):
        ...
        f_update = theano.function([learning_rate], [], updates=ru2_up + param_up, on_unused_input='ignore',
                                   profile=False)
...
class RMSProp(Optimizer):
    ...
    def apply(cls, learning_rate, parameters, grads, inputs, cost):
        ...
        f_update = theano.function([learning_rate], [], updates=updir_new + param_up, on_unused_input='ignore',
                                   profile=False)
